...
function entryFromWikitext(wt) {
  ...
  return Object.assign(
    { hasPage: true, wikiOnly: true, fromTrade: true, statsV: 3 }, box,
    { flags: full.flags, handed: full.handed, ac: full.ac, stats: full.stats, hp: full.hp, mana: full.mana, hpRegen: full.hpRegen, manaRegen: full.manaRegen, haste: full.haste, resists: full.resists, instr: full.instr, container: full.container, effect: full.effect },
